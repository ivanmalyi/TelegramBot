...
/**
 * Trait LoadCommissionFacadeDependenciesTrait
 * @package System\Facade\LoadCommission
 */
trait LoadCommissionsFacadeDependenciesTrait
{
    /**
    ...
    {
        if ($this->commissionsRepository === null) {
    ...
    {
        if ($this->chequesCommissionsRepository === null) {
