Feature: GetSections
  User presses the "other services" button and
  the telegram server sends a request.

  Scenario: Sending request when the user is pressed "other services" button
    ...
    """
    {
      ...
      "callback_query": {
        ...
        "data": "{\"KbAction\":\"get_sections\", \"BtnId\":0}"
      }
    }
    """
    ...
    And Database table "chats" consist:
      ...
      | 1 | 1       | 4             | 1                 | 0                 | "RU"                 | {ReceiverTGChatId} | 1           | 380670000001 |
